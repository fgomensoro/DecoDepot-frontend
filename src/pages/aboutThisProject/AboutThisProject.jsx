          ...
          <div className={styles.firstTextContainer}>
            <div className={styles.projectTextContainer}>
              ...
              <p className={styles.projectText}>
                ...
                theoretical and practical load, it had the duration of three months and more than
                600 hours dictated full time. The objective of the final project is to put into
                practice the knowledge acquired using different technologies. During the three weeks
                that the project lasted, it took approximately 160 hours per member. This is the
                result of the effort, coordination and time of four different people, working
                remotely but in constant communication. Everything was created from scratch,
                including the design, architecture and database.
              </p>
            </div>
          ...
          <div className={styles.textSectionContainer}>
            <div className={styles.textSection}>
              ...
              <p className={styles.projectText}>
                ...
                (Entity-Relationship Model) and the basic structure of the project. For the design
                of our e-commerce we took ideas from other similar sites, taking the best of each
                one and adjusting them to our site.
              </p>
            </div>
            <div className={styles.textSection}>
